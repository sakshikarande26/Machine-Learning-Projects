...
df_train = pd.read_csv(r'C:/Users/admin/PycharmProjects/pythonProject/KDDTrain+.txt', header=None, names=columns)
df_test = pd.read_csv(r'C:/Users/admin/PycharmProjects/pythonProject/KDDTest+.txt', header=None, names=columns)
